...
#ifndef _ICEBERGCOINRPC_H_
#define _ICEBERGCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Icebergcoin is not connected
...
/**
 * Icebergcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
